...
class empDetailForm(models.Model):
	...
	internship_report_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	internship_report_file2 = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
...
class rd(models.Model):
	...
	w_s_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	w_n_d = models.IntegerField( blank=True, null=True)
	w_n_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	w_i_d = models.IntegerField( blank=True, null=True)
	w_i_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	w_m = models.CharField(max_length=500, blank=True, null=True)

	p_s_d = models.IntegerField( blank=True, null=True)
	p_s_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	p_n_d = models.IntegerField( blank=True, null=True)
	p_n_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	p_i_d = models.IntegerField( blank=True, null=True)
	p_i_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)


	p_m = models.CharField(max_length=500, blank=True, null=True)

	onl_course_c = models.IntegerField( blank=True, null=True)
	onl_course_c_file1 = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	onl_course_c_file2 = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	book_i_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	book_n = models.IntegerField( blank=True, null=True)
	book_n_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	book_ci = models.IntegerField(blank=True, null=True)
	book_ci_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	book_cn = models.IntegerField(blank=True, null=True)
	book_cn_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	book_ai = models.IntegerField( blank=True, null=True)
	book_ai_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)

	book_nm = models.IntegerField( blank=True, null=True)
	book_nm_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	if_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	ef_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	eef_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	Cw_2_5_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	Cw_5 = models.CharField(max_length=500, blank=True, null=True)
	Cw_5_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	ipr_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
...
class conference(models.Model):
	...
	c1_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	c2_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	c3_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	c4_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	c5_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	c6_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	c7_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	c8_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
...
class journal(models.Model):
	...
	j1_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	j2_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	j3_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	j4_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	j5_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	j6_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	j7_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
	...
	j8_file = ContentTypeRestrictedFileField(content_types=['application/msword','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.wordprocessingml.document','image/png','text/plain','application/zip','image/jpeg','application/pdf', ],max_upload_size=5242880,blank=True, null=True)
