...
#high_qual stands for highest qualification
	...
	exp_teach = models.CharField(blank=True, null=True) #teaching experience
	exp_res = models.CharField( blank=True, null=True) #research experience
	exp_indus = models.CharField(blank=True, null=True) #industry experience
	info = models.ForeignKey('User', on_delete=models.CASCADE,null=True)
